...
class Boss(commands.GroupCog):
    ...
    async def select(
        ...
        if "✨" in messageforuser:
            ...
            messageforuser = f"{ball.description(short=True, include_emoji=True, bot=self.bot)} has been selected for this round, with {ballattack}+100 ATK and {ballhealth}+100 HP"
            ballhealth += 100
            ballattack += 100
        else:
            pass
