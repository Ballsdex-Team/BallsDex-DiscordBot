...
class TradeOffer(models.Model):
    ...
    player: fields.ForeignKeyRelation[Player] = fields.ForeignKeyField("models.Player")
    ball: fields.ForeignKeyRelation[BallInstance] = fields.ForeignKeyField("models.BallInstance")
